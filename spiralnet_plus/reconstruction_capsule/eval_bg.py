...
parser.add_argument('--device_idx', type=int, default=2)
...
parser.add_argument('--out_channels',
                    ...
                    default=[32, 32, 32, 64],
                    type=int)
parser.add_argument('--latent_channels', type=int, default=200)
...
checkpoint_file = '/home/lau/env/code/python/VAE_mesh/spiralnet_plus/reconstruction_capsule/out/interpolation_exp/capsules_without_moise/checkpoint_299.pt'
